sed -i '/deb-src/s/^# //' /etc/apt/sources.list && apt update # first enable Sources in your repos (as some of these will be built from source, so they will require build-dep)
